module Awestruct
  module Extensions
    class Posts
      # Copied from Awestruct main to apply https://github.com/awestruct/awestruct/pull/548/ https://github.com/awestruct/awestruct/issues/547
        ...
        site.pages.each do |page|
          ...
          if ( page.relative_source_path =~ /^#{@path_prefix}\// )
            ...
            if (page.date?)
              ...
              page.date = date
              slug = $1
              # patch here to accept years up to 2999
